...
def run_linking(toc_path, book_path, output_path):
    print(":blue_book: Loading TOC and Book data...")
    raw_toc = []
    ...
    print(":link: Building final structured IDs and linking metadata...")
    final_results = []
    ...
    print(f":white_check_mark: Linking complete! Saved to: {output_path}")

if __name__ == "__main__":
    # Update these paths to your actual local files
    TOC_PATH = "modules/output/toc/toc4_toc.json"
    BOOK_PATH = "modules/output/extraction_results/class_4_Maths_Ncert_standalone.json"
    OUT_PATH = "modules/output/linked_results/class_4th_maths_structured.json"
